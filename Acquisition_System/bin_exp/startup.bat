...
SET COMMON_JARS=!LIB_PATH!/acquisition-authentication-0.0.10-SNAPSHOT.jar;!LIB_PATH!/acquisition-db-0.0.10-SNAPSHOT.jar;!LIB_PATH!/acquisition-device-0.0.10-SNAPSHOT.jar;!LIB_PATH!/acquisition-domain-0.0.10-SNAPSHOT.jar;!LIB_PATH!/acquisition-messaging-0.0.10-SNAPSHOT.jar;!LIB_PATH!/acquisition-sdiv-0.0.10-SNAPSHOT.jar
SET ACQUISITION_JARS=!LIB_PATH!/acquisition-archiving-0.0.10-SNAPSHOT.jar;!LIB_PATH!/acquisition-configuration-0.0.10-SNAPSHOT.jar;!LIB_PATH!/acquisition-description-0.0.10-SNAPSHOT.jar;!LIB_PATH!/acquisition-eurofleets-0.0.10-SNAPSHOT.jar;!LIB_PATH!/acquisition-launcher-0.0.10-SNAPSHOT.jar
SET VISUALIZATION_JARS=!LIB_PATH!/acquisition-visualization-0.0.10-SNAPSHOT.jar
...
IF "%1%" == "acquisition" (
	...
	SET LAUNCHER=fr.ifremer.acquisition.visualization.VisualizationLauncher
